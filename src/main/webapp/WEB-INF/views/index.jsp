    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .auth-card {
            ...
            width: 100%;
            max-width: 600px; /* Slightly wider for candidate form */
            padding: 40px;
            border-radius: 16px;
...
<body>
    ...
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p>Join OFRS to find and apply for the best faculty positions.</p>
        </div>
        ...
        <form action="register" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="qualification" name="qualification" placeholder="e.g. Ph.D., M.Tech">
            </div>
            <div class="form-group">
        ...
        <div class="auth-footer">
            Already have an account? <a href="loginCandidate">Log in here</a>
