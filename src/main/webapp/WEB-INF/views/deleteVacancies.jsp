...
<style>
    ...
    /* ------------------------------------------------------------------ */
    /* --- SECTION 2: FORM AND INPUT STYLES (Used by all forms) --- */
    /* ------------------------------------------------------------------ */
    ...
    /* Overriding submit button for destructive action */
    .btn-delete {
        background-color: var(--error-text); /* Red color for deletion */
    }
    .btn-delete:hover {
    ...
    :root {
        ...
        --submit-color: #28a745; /* Green submit button (default) */
...
<div class="container">
    ...
    <p style="color: var(--error-text); font-weight: bold; margin-bottom: 20px;">
        Warning: Deleting a vacancy is permanent.
    </p>
    ...
    <form action="vacanciesDelete" method="post">
        ...
        <input type="text" name="post" placeholder="Enter Post Name">
        
        <!-- Submit button uses the destructive class -->
        <input type="submit" value="DELETE VACANCY" class="btn-delete">
    </form>
